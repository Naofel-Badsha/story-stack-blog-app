...
const Footer = () => {
  return (
    ...
    <footer className="bg-[#F6F6F6] dark:bg-gray-900 pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">

          {/* Brand Section */}
          <div className="col-span-1 md:col-span-1">
            <Link to="/" className="text-2xl font-medium dark:text-gray-300">Story<span className='text-[#E64839]'>&</span>Stack</Link>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-lg text-gray-800 dark:text-gray-300 font-semibold mb-4 border-b border-gray-700 pb-2">Quick Links</h3>
          ...
          {/* Categories */}
          <div>
            <h3 className="text-lg text-gray-800 dark:text-gray-300 font-semibold mb-4 border-b border-gray-700 pb-2">Categories</h3>
            <ul className="space-y-2 text-gray-600 dark:text-gray-400 text-sm">
          ...
          {/* Newsletter */}
          <div>
            <h3 className="text-lg text-gray-800 dark:text-gray-300 font-semibold mb-4 border-b border-gray-700 pb-2">Newsletter</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">Subscribe to get updates on new posts.</p>
