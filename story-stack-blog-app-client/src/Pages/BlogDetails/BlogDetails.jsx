    ...
    <section className="container m-auto py-20 px-4 lg:px-0">
      <div>
        ...
        <div className='flex items-center mb-4'>
          <img src="https://i.ibb.co.com/cSdSSgKr/author-4.png" alt="" className='w-10 h-10 rounded-full mr-3' />
          <div>
        ...
        <img src="https://i.ibb.co.com/DfS9hk2Q/imageye-imgi-138-Ma-SH-Automation-graphic.webp" alt="" className='w-full md:h-[580px] rounded-md object-cover mb-4' />
        <div className='space-y-4'>
          <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Adipisci facere numquam odit asperiores, aliquam corrupti a dolores veniam, ut ipsum nam est ullam tempore itaque ex possimus nisi neque quasi.</p>
