...
const About = () => {
  return (
    <section className='py-20 pb-5 px-4 lg:px-0'>
      <div className='container mx-auto  text-primary'>
        ...
        <motion.div
          ...
          className='flex items-center justify-center text-center mb-20 md:min-h-[300px] h-80 w-full bg-center bg-cover rounded-xl' style={{ backgroundImage: `url("https://i.ibb.co.com/9kVqMZt9/imageye-imgi-453-modern-dark-theme-background-with-abstract-geometric-shapes-1106493-429548.webp")` }}>
