...
const Contact = () => {
  return (
    <section className='pt-20 pb-5 px-4 lg:px-0'>
      <div className='container mx-auto '>
        ...
        <motion.div
          ...
          className='flex items-center justify-center text-center mb-20 md:min-h-[300px] h-80 w-full bg-center bg-cover rounded-xl' style={{ backgroundImage: `url("https://i.ibb.co.com/tM2XBzcN/imageye-imgi-121-ai-chip-hovers-above-hand-600nw-2675149399.webp")` }}>
