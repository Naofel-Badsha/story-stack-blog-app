...
const AddBlog = () => {
  ...
  return (
    <section>
      <div>
        <h1 className="text-3xl text-center py-10">Add New Blog</h1>
      </div>
        ...
        <div className="flex-1">
          <form onSubmit={handleSubmit(onSubmit)} className='bg-white p-6 rounded-lg shadow-md'>
            ...
            <div>
              <button
                type='submit'
                className='w-full bg-[#E64839] text-white py-2 px-4 rounded-lg hover:bg-gray-800 cursor-pointer'>Add New Blog</button>
            </div>
          </form>
        </div>
      </div>
